  ...
  switch (name) {
    case 'home':
      return {
        viewBox: '0 0 24 24',
        shapes: [
          shape('path', { d: 'M4 11.5 12 4l8 7.5', fill: 'none', stroke: 'currentColor', 'stroke-width': '2', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' }),
          shape('path', { d: 'M6 10.5V20h12v-9.5', fill: 'none', stroke: 'currentColor', 'stroke-width': '2', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' }),
        ],
      };
